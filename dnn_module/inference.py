...
def inference(model, testset_loader, opt, threshold):
    ...
    with torch.no_grad(): # This will free the GPU memory used for back-prop
        ...
        if opt.infer_val:
            ...
            df_id_output_softmax.pred_softmax = df_id_output_softmax.pred_softmax.astype('float32')
            ...
            df_id_softmax_threshold.pred = df_id_softmax_threshold.pred.astype('float32')
